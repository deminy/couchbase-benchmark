...
// In this section, we are importing Couchbase 2 constants to Couchbase 3.
// Inside the bootstrap file for PHPUnit (file ./tests/bootstrap.php), there is also a small section to import Couchbase
// 3 constants to Couchbase 2.
if (!defined('COUCHBASE_KEY_ENOENT')) {
